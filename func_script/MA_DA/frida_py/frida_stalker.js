...
//                    // check if the function belongs to ntdll
//                    try {
//                        var mod2 = Process.findModuleByAddress(retval);
//                        if (mod2 && mod2.name.toLowerCase().indexOf("ntdll") !== -1) {
//                            send({
//                                type: "GetProcAddress",
//                                event: "skip_ntdll",
//                                procName: this.apiName || "unknown",
//                                address: funcAddrStr,
//                                timestamp: getTimestamp()
//                            });
//                            return; // 스킵: ntdll에 있는 API는 후킹하지 않음
//                        }
//                    } catch (e) {}
//                    
