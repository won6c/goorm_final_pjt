...
def run_procdump_and_analyze(process_name):
    ...
    cmd = ["python", "Procdump.py", process_name]
    try:
    ...
    # 생성된 덤프 파일 경로
    memory_dump = r"C:\Users\User\Desktop\MEM\memory_dump.dmp"  # 생성된 덤프 경로로 수정 필요
    return memory_dump
...
def main():
    ...
    if memory_dump:
        output_dir = r"C:\Users\User\Desktop\MEM\results"
