...
def create_memory_dump(process_name):
    ...
    dump_file_path = os.path.join(r"C:\Users\User\Desktop\MEM", f"memory_dump_{timestamp}.dmp")

    # Procdump 실행 명령어
    cmd = ["C:\\Users\\User\\Desktop\\MEM\\tool\\procdump.exe", process_name, "-ma", dump_file_path]
