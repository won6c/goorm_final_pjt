...
import subprocess
import os
from static_analysis.suspicious import suspicious_apis, packing_signatures
...
def analyze_pe(file_path):
    ...
    output_file = os.path.join(OUTPUT_PATH, f"{os.path.basename(file_path)}_analysis.json")
